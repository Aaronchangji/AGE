...
# cmd = '{} --version'.format(clang_format)
# os.system(cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', choices=['replace', 'check'], default='check', help='Replace for all c++ codes or check them only with clang-format')
